...
const Resources = {
    ...
    PressurePlateGreen: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-green/pressure-plate-green.png",
    ),
    PressurePlateGreenActivated: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-green/pressure-plate-green-activated.png",
    ),

    pressurePlateOrangeBase: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-orange/pressure-plate-orange-base.png",
    ),
    PressurePlateOrange: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-orange/pressure-plate-orange.png",
    ),
    PressurePlateOrangeActivated: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-orange/pressure-plate-orange-activated.png",
    ),

    PressurePlateWeigtedBase: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-weighted/pressure-plate-weighted-base.png",
    ),
    PressurePlateWeigted: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-weighted/pressure-plate-weighted.png",
    ),
    PressurePlateWeigtedActivated: new ImageSource(
        "images/objects/pressure-plate/pressure-plate-weighted/pressure-plate-weighted-activated.png",
    ),

    // Platform
    DefaultPlatform: new ImageSource(
        "images/objects/moving-platform/default-platform.png",
    ),
    PurplePlatform: new ImageSource(
        "images/objects/moving-platform/purple-platforms/purple-platform.png",
    ),
    YellowPlatform: new ImageSource(
        "images/objects/moving-platform/yellow-platforms/yellow-platform.png",
    ),
    PurpleYellowPlatform: new ImageSource(
        "images/objects/moving-platform/purple-yellow-platform.png",
    ),
    ...
    BackgroundFront: new ImageSource(
        "images/backgrounds/background-front-layer.png",
    ),
    BackgroundSecond: new ImageSource(
        "images/backgrounds/background-second-layer.png",
    ),
    BackgroundThird: new ImageSource(
        "images/backgrounds/background-third-layer.png",
    ),
    BackgroundBack: new ImageSource(
        "images/backgrounds/background-back-layer.png",
    ),
    BackgroundSky: new ImageSource("images/backgrounds/background-sky.png"),
    BackgroundBottomFill: new ImageSource(
        "images/backgrounds/background-bottom-fill.png",
    ),
