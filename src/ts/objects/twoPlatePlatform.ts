...
export class TwoPlatePlatform extends Platform {
    ...
    registerPressurePlateActivated() {
        ...
        this._pressureActive = this._activePressurePlates >= this.requiredPlates;
        if (this.movementMode === MovementMode.PressurePlate && this._pressureActive) {
            this.moving = true;
        }
    }
